...
function ArtistHome() {
  ...
  return (
    <>
      <ArtistNavbar />
        <h1 className="text-center font-semibold text-slate-500 mt-5 text-3xl">My Profile</h1>
      ...
      <div className="px-6">
        <div className="flex flex-wrap justify-center">
          ...
          <div className="w-full text-center mt-20">
            <div className="flex justify-center lg:pt-4 pt-8 pb-0">
              <div className="p-3 text-center cursor-pointer" onClick={()=>navigate(ServerVariables.artistPosts)}>
        ...
        <span className="text-slate-500 cursor-pointer flex justify-center" onClick={openRatingModal}>
