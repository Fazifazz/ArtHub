          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1 ml-4">
              ...
              <p className="text-gray-700 ">
                ...
                Seamless Collaboration: Our platform ensures smooth communication and artworks management.
                Verified Artists: Our subscription model guarantees quality and commitment.
                Tailored Matches: Find artists or artworks that align perfectly with your goals.
              </p>
              <h2 className="text-3xl font-semibold mb-4">Our Misson</h2>
              <p className="text-gray-700 mt-4 ">
                At ArtHub, we're on a mission to simplify
                artwork collaborations. By providing artists
                with a subscription-based platform and offering clients
                direct access to skilled artists, we're revolutionizing
                    ...
                    <div class="md:flex md:justify-between">
                        <div class="mb-6 md:mb-0">
                            <a href="https://flowbite.com/" class="flex items-center">
                                ...
                                <h1 class="self-center text-2xl font-semibold whitespace-nowrap text-white">ArtHub</h1>
                            </a>
                        </div>
